...
extension InformationStorageButton {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        NavigationLink(destination: InformationStorageOptionsView(), label: {
            Image(systemName: __designTimeString("#8039.[1].[0].property.[0].[0].arg[1].value.[0].arg[0].value", fallback: "cpu"))
                .resizable()
                .scaledToFit()
                ...
                .background(
                    RoundedRectangle(cornerRadius: __designTimeInteger("#8039.[1].[0].property.[0].[0].arg[1].value.[0].modifier[4].arg[0].value.arg[0].value", fallback: 25))
                ...
                .padding(__designTimeInteger("#8039.[1].[0].property.[0].[0].arg[1].value.[0].modifier[5].arg[0].value", fallback: 30))
        })
    #sourceLocation()
    }
}
